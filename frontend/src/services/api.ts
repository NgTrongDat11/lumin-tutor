...
export const authApi = {
  ...
  updatePassword: (data: any) =>
    api.post<any>('/auth/me/password', data).then((res) => res.data),
};
...
export const tutorApi = {
  browse: () =>
    api.get<ApiResponse<TutorPublicResponse[]>>('/tutor/browse').then(unwrap),
...
export const subjectApi = {
  list: () =>
    api.get<ApiResponse<SubjectResponse[]>>('/subjects').then(unwrap),
  ...
  delete: (id: number) =>
    api.delete<ApiResponse<null>>(`/subjects/${id}`).then(unwrap),
};
